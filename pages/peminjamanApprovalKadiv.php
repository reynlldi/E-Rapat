<?php
    ...
    if(isset($_GET['IDPeminjaman'])){
        ...
        $objPeminjaman->SetujuiPeminjamanKabid();
        ...
        if($objPeminjaman->hasil){			
            ...
            $objMail = new Mail();
            $objMail->SendMail($objRegister->email, $objRegister->nama, 'Kepala Bidang Telah Menyetujui', $message);	
