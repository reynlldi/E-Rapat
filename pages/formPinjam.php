  ...
  if (isset($_POST['btnSubmit'])){
    ...
    if (isset($_GET['IDPeminjaman'])) {
      ...
      if($objPeminjaman->hasil){			
        ...
        $header = "Permintaan Peminjaman Ruangan";
        ...
        $objMail->SendMail('reynalddi6633@gmail.com', $objRegister->nama, 'Permintaan Peminjaman Ruangan', $message);
      ...
      <div class="col-md-9">
        ...
        <form action="" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nama" placeholder="<?php echo $_SESSION["nama"] ?>"
          ...
          <div class="form-row form-group">
            <div class="col mt-2">
              ...
              <input type="text" class="form-control" id="ruangan" name="ruangan"
                placeholder="<?php echo $objRuangan->namaRuangan; ?>" value="<?php echo $objRuangan->namaRuangan; ?>"
                readonly>
            </div>
            <div class="col mt-2">
              <label for="lantai">Lantai </label>
              <input type="text" class="form-control" id="lantai" name="lantai"
                placeholder="<?php echo $objRuangan->lantai ?>" value="<?php echo $objRuangan->lantai; ?>" readonly>
            </div>
          </div>
          ...
          <div class="form-group mt-2">
            ...
            <textarea class="form-control" id="keperluan" name="keperluan" rows="3" style="height:100%"
              required></textarea>
          </div>
          ...
          <div class="mt-2">
            <input type="submit" name="btnSubmit" style="background-color: #1f4690;"
              class="btn text-light btn-block m-1" value="Pinjam">
            <a href="dashboardMahasiswa.php?p=listRuangan" class="btn btn-danger btn-block">Batal</a>
          </div>
        </form>
      </div>
    </div>
