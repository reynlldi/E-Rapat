<?php
    ...
    if(isset($_GET['IDPeminjaman'])){
        ...
        if($objPeminjaman->hasil){			
            ...
            $body = '<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
                        ...
                        <tr>
                            <td colspan="3" align="center">
                                <h1>Peminjaman Ruangan Dibatalkan</h1>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3" align="center">
            ...
            $footer ='Peminjaman ruangan telah dibatalkan, silakan login untuk memeriksa persetujuan peminjaman ruangan';
            ...
            $objMail = new Mail();
            $objMail->SendMail($objRegister->email, $objRegister->nama, 'Peminjaman Ruangan Dibatalkan', $message);	
            echo "<script> alert('Pembatalan Peminjaman Ruangan Ruangan Berhasil'); </script>";
