...
class FasilRuangan extends Connection{
    ...
    public function SelectAllFasilRuanganWithID($IDPeminjaman){
        $this->connect();
        $sql = "SELECT fasilitas.jenisFasilitas, fasilitas_ruangan.jumlah FROM fasilitas_ruangan JOIN fasilitas ON fasilitas_ruangan.IDFasilitas = fasilitas.IDFasilitas WHERE fasilitas_ruangan.IDPeminjaman = $IDPeminjaman ";
